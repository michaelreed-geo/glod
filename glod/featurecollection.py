"""FeatureCollection type for the glod package.

This module provides a container classes for collecting features, with optional
metadata, mirroring the GeoJSON ``FeatureCollection`` structure:
